...
public interface BluetoothDevicePicker {
    ...
    /**
     * Ask device picker to show BT devices that support Personal Area
     * Networking User (PANU) profile
     */
    public static final int FILTER_TYPE_PANU = 3;
    /**
     * Ask device picker to show BT devices that support Network Access Point
     * (NAP) profile
     */
