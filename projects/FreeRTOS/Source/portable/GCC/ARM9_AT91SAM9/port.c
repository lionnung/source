...
/*
 * Setup the Perodic Interrupt Timer to generate the tick interrupts at the required frequency.
 */
static void prvSetupTimerInterrupt( void )
{
const unsigned long ulPeriodIn_uS = ( 1.0 / ( double ) configTICK_RATE_HZ ) * port1SECOND_IN_uS;
	...
	on whether the preemptive or cooperative scheduler is being used. */
	    ...
	    IRQ_ConfigureIT( AT91C_ID_SYS, configKERNEL_INTERRUPT_PRIORITY, ( void (*)(void) ) vNonPreemptiveTick );
	    
	#else
		
		extern void ( vPreemptiveTick )( void );
		IRQ_ConfigureIT( AT91C_ID_SYS, configKERNEL_INTERRUPT_PRIORITY, ( void (*)(void) ) vPreemptiveTick );
